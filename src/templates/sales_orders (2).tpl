<div id="nav-menu" class="toolbar">
    <ul><li><a href="{$AppURL}index.php?file=sales_orders"><img src="{$AppImgURL}view_all.png" align="absmiddle"> View All</a></li><li><a href="{$AppURL}index.php?file=pre_admission&action=add"><img src="{$AppImgURL}add.png" align="absmiddle"> Add New</a></li></ul>
