<div id="nav-menu" class="toolbar">
    <ul><li><a href="{$AppURL}index.php?file=subjects"><img src="{$AppImgURL}view_all.png" align="absmiddle"> View All</a></li><li><a href="{$AppURL}index.php?file=subjects&action=add"><img src="{$AppImgURL}add.png" align="absmiddle"> Add New</a></li></ul>
</div>{if $content_details_array.formelements neq ''}
        {$content_details_array.page.viewactions}
            
<form name="subjects_form" id="subjects_form" method="post" action="{$content_details_array.current_page}" >
...
<td width="200px">{include file="formelements/input.tpl" inputDetails=$content_details_array.formelements.name}</td>
</tr>
<tr id="row_code">
<td width="200px" bgcolor="#F2F2F2" align="right">Code</td>
<td width="200px">{include file="formelements/input.tpl" inputDetails=$content_details_array.formelements.code}</td>
</tr>
</table> 
 </p> 
</div>
...
{literal}{/literal}{else}
    ...
    {html_table loop=$content_details_array.viewall.data cols=$content_details_array.viewall.columnnames rows=$content_details_array.viewall.rowcount table_attr="id='subjects'"}
    {literal}
        <script>
