<div id="nav-menu" class="toolbar">
    <ul><li><a href="{$AppURL}index.php?file=route_details"><img src="{$AppImgURL}view_all.png" align="absmiddle"> View All</a></li><li><a href="{$AppURL}index.php?file=route_details&action=add"><img src="{$AppImgURL}add.png" align="absmiddle"> Add New</a></li></ul>
</div>{if $content_details_array.formelements neq ''}
        {$content_details_array.page.viewactions}
            
<form name="route_details_form" id="route_details_form" method="post" action="{$content_details_array.current_page}" >
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}{include file="formelements/input.tpl" inputDetails=$content_details_array.formelements.route_name}{/if}</td>
</tr>
<tr id="row_route_no">
<td width="200px" bgcolor="#F2F2F2" align="right">Route No</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                    {include file="formelements/label.tpl" inputDetails=$content_details_array.formelements.route_no}
                
                {else}{include file="formelements/input.tpl" inputDetails=$content_details_array.formelements.route_no}{/if}</td>
</tr>
</table> 
 </p> 
</div>
...
{literal}{/literal}{else}
    ...
    {html_table loop=$content_details_array.viewall.data cols=$content_details_array.viewall.columnnames rows=$content_details_array.viewall.rowcount table_attr="id='route_details'"}
    {literal}
        <script>
