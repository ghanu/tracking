<div id="nav-menu" class="toolbar">
    <ul><li><a href="{$AppURL}index.php?file=__user_menu_details"><img src="{$AppImgURL}view_all.png" align="absmiddle"> View All</a></li><li><a href="{$AppURL}index.php?file=__user_menu_details&action=add"><img src="{$AppImgURL}add.png" align="absmiddle"> Add New</a></li></ul>
</div>{if $content_details_array.formelements neq ''}
        {$content_details_array.page.viewactions}
            
<form name="__user_menu_details_form" id="__user_menu_details_form" method="post" action="{$content_details_array.current_page}" >
...
<td width="200px">{include file="formelements/input.tpl" inputDetails=$content_details_array.formelements.menu_id}</td>
</tr>
<tr id="row_user_id">
...
{literal}{/literal}{else}
    ...
    {html_table loop=$content_details_array.viewall.data cols=$content_details_array.viewall.columnnames rows=$content_details_array.viewall.rowcount table_attr="id='__user_menu_details'"}
    {literal}
        <script>
