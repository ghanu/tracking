...
<tr id="row_photo">
<td width="200px" bgcolor="#F2F2F2" align="right">Student Photo</td>
...
<td width="200px">{include file="formelements/radio.tpl" inputDetails=$content_details_array.formelements.sex}</td>
</tr>
</table> 
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.nationality}
{/if}                    
</td>
</tr>
<tr id="row_religion">
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.mother_tongue}
{/if}                    
</td>
</tr>
<tr id="row_lang_speak_at_home">
<td width="200px" bgcolor="#F2F2F2" align="right">Languages Speak At Home</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                    
                    {include file="formelements/label.tpl" inputDetails=$content_details_array.formelements.lang_speak_at_home}
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.lang_speak_at_home}
{/if}                    
</td>
</tr>
</table> 
...
<td width="200px" bgcolor="#F2F2F2" align="right">Home Address # 1</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
...
<td width="200px" bgcolor="#F2F2F2" align="right">Address line #2</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.haddress_city}
{/if}                    
</td>
</tr>
</table> 
...
<td width="200px" bgcolor="#F2F2F2" align="right">Doctor Name</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.daddress_city}
{/if}                    
</td>
</tr>
<tr id="row_dphone">
...
<td width="200px" bgcolor="#F2F2F2" align="right">Doctors Address #1</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
...
<td width="200px" bgcolor="#F2F2F2" align="right">Academic/Year</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.scity}
{/if}                    
</td>
</tr>
</table> 
...
<td  >
<div class="divframe">
<h4 class="subhead">Transport Details</h4>
 <p>
<table valign="top" class="contenttable">
...
{/if}                    
 ...
 </td><td valign="top"><table><tr id="row_stage">
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.stage}
{/if}                    
</td>
</tr>
<tr id="row_cost">
...
<td width="200px" bgcolor="#F2F2F2" align="right">Person1 Photo</td>
<td width="200px">{if $smarty.get.action eq 'view'}
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
 ...
 </td><td valign="top"><table><tr id="row_person2_phot">
<td width="200px" bgcolor="#F2F2F2" align="right">Person2 Photo</td>
<td width="200px">{if $smarty.get.action eq 'view'}
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.sclass}
{/if}                    
</td>
</tr>
<tr id="row_sschool">
...
<td width="200px">{if $content_details_array.page.action eq 'view'} 
                ...
                {else}
                {include file="formelements/select.tpl" inputDetails=$content_details_array.formelements.sclass1}
{/if}                    
</td>
</tr>
<tr id="row_sschool1">
...
<td width="200px" bgcolor="#F2F2F2" align="right">Previous Assessment Report Card</td>
<td width="200px">{if $content_details_array.page.action eq 'view'} 
            ...
            
{
                   						...
                   						"fnRender": function (oObj) 
                                                                    {
                                                                     return "<a href='"+AppURL+"index.php?file=admission&action=delete&id=" + oObj.aData[0] + "'><img src='"+AppImgURL+"delete.png'></a>  <a href='"+AppURL+"index.php?file=admission&action=edit&id=" + oObj.aData[0] + "'><img src='"+AppImgURL+"edit.png'></a>  <a href='"+AppURL+"index.php?file=admission&action=view&id=" + oObj.aData[0] + "'><img src='"+AppImgURL+"view.png'></a>";
								}
							}]
