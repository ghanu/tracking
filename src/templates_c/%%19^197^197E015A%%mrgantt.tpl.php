<?php /* Smarty version 2.6.26, created on 2013-09-04 20:44:16
         compiled from mrgantt.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_table', 'mrgantt.tpl', 271, false),)), $this); ?>

<div id="nav-menu" class="toolbar">
<?php echo $this->_tpl_vars['graph']->Stroke(); ?>

    <ul><li><a href="<?php echo $this->_tpl_vars['AppURL']; ?>
index.php?file=sales_order"><img src="<?php echo $this->_tpl_vars['AppImgURL']; ?>
