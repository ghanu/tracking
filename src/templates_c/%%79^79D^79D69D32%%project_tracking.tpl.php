<?php /* Smarty version 2.6.26, created on 2013-09-13 21:27:45
         compiled from project_tracking.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_table', 'project_tracking.tpl', 271, false),)), $this); ?>

<div id="nav-menu" class="toolbar">
   
</div><img src="<?php echo $this->_tpl_vars['AppImgURL']; ?>
gantt.jpg"></img>
<?php if ($this->_tpl_vars['content_details_array']['formelements'] != ''): ?>
        <?php echo $this->_tpl_vars['content_details_array']['page']['viewactions']; ?>

         <?php echo $this->_tpl_vars['content_details_array']['viewall']['data1']; ?>
