...
$content_details_array["page"]["heading"]=ucwords("Sales Order Tracking");

$content_details_array["page"]["title"]=ucwords("Sales Order Tracking");
...
<tr>
<td colspan=2><b>Project Number</td><td>333</td><td></td><td></td><td><b>Order Number</td><td>23343</td>
</tr><tr/>
<tr>
<td colspan=2><b>Worker Order </td>
<td>XSSS</td><td></td><td></td><td><b>Requird Date</td><td>XSSS</td>
</tr><tr/><tr/>
<tr>
<td colspan=2><b>Order Quantity </td>
<td>600</td><td></td><td></td><td><b>Delivery Date</td><td>12-12-2013</td>
</tr><tr/>
<td colspan=2><b>Material </td>
<td>600</td><td></td><td></td><td><b>Custome Doc</td><td>12-12-2013</td>
</tr><tr/>
...
//"Status","Target ","GE Revised Dock Date","PO Del Date","Status","Actual  M/C Fin Date","Target M/C Fin Date","NDT	M/C	Vam Top	Cladding","Phosphating","Painting","Shipping","Actual Fin Date","GE Dock Date26th June","GE Revised Dock Date","Remarks"
   $content_details_array["viewall"]["columnnames"]=json_decode('["Operation Seq. No","Op. Text","Work Center","Setup Time","Est. Time","Working Hour","Req Days","Wown Time","Start Date","End Date","Status","Remarks"]');
...
$csv_file = AppRoot.AppScriptURL;
		$csv_file .="Project_tracking.csv"; // Name of your CSV file
		//print_r($csv_file);
