...
if($action =="viewall"){
	 ...
	 'child_date_of_birth' => 'PX16915','class_to_be_admitted'=> '2','parent_name' => 'A110004-66APA1', 'mail' => 'A','mobile' => 'FGGE01-0033','date_of_issue' => 'CONNECTOR-WELLHEAD PART,HT-H4','date_of_returning' => '4','amount_paid' => 'LOWER2BODY' ,'payment_mode' => '18-3/4','cheque_no' => '2', 'bank_name' => '100002' ,'bill_no' => '0001','date_of_pre_screening' => '30/03/2012','time_of_pre_screening' => '09:40 am','screening_id' => 1,'branch_id' => 1 ,'date_timestamp' =>' 2012-03-22 19:29:09' ,'status' => 0 ,'action' => 1,id=>ll);
	...
	$content_details_array["viewall"]["data"]=$array;
    ...
    $content_details_array["viewall"]["columnnames"]=json_decode('["SI No","Customer","PO Date","PO Number","PO Line","Part No","Rev","Nav Material","Part Descprtion","PO Qty","Delivered Qty","Bal. Qty","Planned Delivery","Status","Target ","GE Revised Dock Date","Time Of Pre Screening","Screening Id","Branch Id","Date Timestamp","Status","Action"]');
}
 ?><script>
