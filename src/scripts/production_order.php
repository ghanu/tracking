<?php include_once AppRoot . AppController . "cProduction_orderController.php";

$pre_admissionObj = new cProduction_orderController();
...
$content_details_array["page"]["heading"]=ucwords("Production Order");

$content_details_array["page"]["title"]=ucwords("Production Order");
...
if($action =="viewall"){
   ...
   $content_details_array["viewall"]["columnnames"]=json_decode('["Order No","Qty","Order No","status","Description",
   "Route Description","Start Date","End Date","Due Date"]');   
