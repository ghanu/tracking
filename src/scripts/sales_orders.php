...
//"Status","Target ","GE Revised Dock Date","PO Del Date","Status","Actual  M/C Fin Date","Target M/C Fin Date","NDT	M/C	Vam Top	Cladding","Phosphating","Painting","Shipping","Actual Fin Date","GE Dock Date26th June","GE Revised Dock Date","Remarks"
   $content_details_array["viewall"]["columnnames"]=json_decode('["SI No","Customer","PO Date","PO Line","Part No","Rev","Nav Material","PO Qty","Delivered Qty","Bal. Qty","Planned Delivery","Status","Actual  M/C Fin Date","Target M/C Fin Date","Actual Fin","Remarks"]');
