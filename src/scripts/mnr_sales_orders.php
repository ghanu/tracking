...
if($action =="viewall"){
   ...
   $content_details_array["viewall"]["columnnames"]=json_decode('["Order No","Customer","No","Order Date","Due Date","Nav Material","Description","Order Qty",
   "Deli. Qty","Bal. Qty","Shipped Qty","Shippment Date","Planned Shippment Date"]');
