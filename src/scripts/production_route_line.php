<?php include_once AppRoot . AppController . "cProduction_route_lineController.php";

$pre_admissionObj = new cProduction_route_lineController();
...
$content_details_array["page"]["heading"]=ucwords("Production Routing Line");

$content_details_array["page"]["title"]=ucwords("Production Routing Line");
...
if($action =="viewall"){
   ...
   $content_details_array["viewall"]["columnnames"]=json_decode('["staus","Routing No","Operation No","Work Center","description",
