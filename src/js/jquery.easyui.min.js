...
$(_5c9).datagrid($.extend({},opts,{cls:"propertygrid",view:(opts.showGroup?_5ca:undefined),onClickRow:function(_5cb,row){
if(opts.editIndex!=_5cb&&row.editor){
...
$(_5c9).datagrid("getPanel").find("div.datagrid-group").css("border","0");
opts.onLoadSuccess.call(_5c9,data);
}}));
...
var t=$(_5c9);
t.datagrid("getEditors",_5cd)[0].target.blur();
...
var _5da=_5d9[i];
_5d7.push("<div class=\"datagrid-group\" group-index="+i+" style=\"height:25px;overflow:hidden;border-bottom:1px solid #ccc;\">");
...
var cls=(_5d8%2&&opts.striped)?"class=\"datagrid-row datagrid-row-alt\"":"class=\"datagrid-row\"";
