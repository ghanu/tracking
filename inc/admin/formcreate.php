...
';
    ...
    $scriptDetailsArray[] = '$content_details_array["page"]["heading"]=ucwords("' . $_POST['pageheading'] . '");' . "\n";
    $scriptDetailsArray[] = '$content_details_array["page"]["title"]=ucwords("' . $_POST['pagetitle'] . '");' . "\n";
...
';
    ...
    if ($_POST['layout'] == 'vertical') {
        ...
        foreach ($grouparray as $framename => $framedata) {
            ...
            foreach ($framedata as $key => $value) {
                ...
                if ($formdetailsArray[$key]) {
                    ...
                    $formDetails.='<td width="200px" bgcolor="#F2F2F2" align="right">' . $_POST[$key] . '</td>' . "\n";
        ...
        foreach ($formdetailsArray as $key => $value) {
            $formdesigndetails.=$formDetails.='<th>' . $_POST[$key] . '</th>' . "\n";
        }
        $formdesigndetails.=$formDetails.='</tr>' . "\n";
        $formdesigndetails.=$formDetails.='<tr>' . "\n";
        foreach ($formdetailsArray as $key => $value) {
