...
class Smarty
{
     ...
     * @var string
     */
    var $template_dir    =  'src/templates';
     ...
     * @var string
     */
    var $compile_dir     =  'src/templates_c';
     ...
     * @var string
     */
    var $debugging_ctrl  =  'http://localhost/gbase/index.php?SMARTY_DEBUG';
 ...
 */
    ...
    function Smarty()
    {
        $this->template_dir=AppRoot."/".$this->template_dir;
        $this->compile_dir=AppRoot."/".$this->compile_dir;
        AppRoot.
