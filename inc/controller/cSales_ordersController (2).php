...
class cSales_ordersController extends cController {
 ...
 function curd() {
        if($this->action=="viewall"){
            $this->column=array("sales_order.order_no","sales_order.customer","sales_order.po_date","sales_order.po_line",
			"sales_order.part_number","sales_order.rev","sales_order.nav_material","sales_order.part_qty","sales_order.delivery_qty",
			"sales_order.balance_qty","sales_order.planned_delivery","sales_order.status","sales_order.actual_mc","sales_order.target_mc",
			"sales_order.actual_finish","sales_order.remarks");
