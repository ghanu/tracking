...
class cProduction_lineController extends cController {
 public $action="viewall";
    public $id="";
    public $view_controls=array();	
    function __construct() {
        parent::__construct();
        $this->table = "prod_order_line as pr";
        $this->action="viewall";
    }
    
 function curd() {
        if($this->action=="viewall"){
            $this->column=array("status","prod_order_no","line_no","item_no","description","location_code",
 "qty","finished_qty","due_date","start_date","end_date","route_no","route_reference_no"
