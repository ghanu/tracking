...
class cProduction_route_lineController extends cController {
 public $action="viewall";
    public $id="";
    public $view_controls=array();	
    function __construct() {
        parent::__construct();
        $this->table = "prod_order_routing_line as pr";
        $this->action="viewall";
    }
    
 function curd() {
        if($this->action=="viewall"){
            $this->column=array("status","routing_no","operation_no","work_center_no","description",
