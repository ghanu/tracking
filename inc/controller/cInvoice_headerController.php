...
class cInvoice_headerController extends cController {
 public $action="viewall";
    public $id="";
    public $view_controls=array();	
    function __construct() {
        parent::__construct();
        $this->table = "invoice_header as pr";
        $this->action="viewall";
    }
    
 function curd() {
        if($this->action=="viewall"){
            $this->column=array("invoice_no,customer,order_date,posting_date,shipping_date,due_date,posting_description,external_doc"
			
			);
			
          //$this->join_condition="Left Join route_header as rh on rh.route_no =pr.route_no";    
		 $this->join_condition="where customer='VETCO GRAY PTE LTD'";    
